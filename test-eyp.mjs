...
belgeHedefFolder.file('BelgeHedef.xml', `<?xml version="1.0" encoding="utf-8"?>
...
// PaketOzeti.xml - hash'ler dummy
const paketOzetiFolder = zip.folder('PaketOzeti');
paketOzetiFolder.file('PaketOzeti.xml', `<?xml version="1.0" encoding="utf-8"?>
...
imzalarFolder.file('BelgeImza.xml', `<?xml version="1.0" encoding="utf-8"?>
...
// NihaiOzet.xml
const nihaiOzetFolder = zip.folder('NihaiOzet');
nihaiOzetFolder.file('NihaiOzet.xml', `<?xml version="1.0" encoding="utf-8"?>
...
fs.writeFileSync('test-generated.eyp', blob);
console.log('Test EYP created: test-generated.eyp');

// Also list contents
console.log('\nGenerated EYP contents:');
const testZip = await JSZip.loadAsync(blob);
for (const filename of Object.keys(testZip.files)) {
